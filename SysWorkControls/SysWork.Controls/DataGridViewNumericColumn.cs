...
{
    public partial class DataGridViewNumericColumn : DataGridViewColumn
    {
        ...
        internal NumberFormatInfo NumberFormat
        {
            get
            {
                ...
                /*
                 TODO: Urgente tomar de algun lado esto
                 */
        ...
        public DataGridViewNumericColumn():base (new NumericGridCell()) { }
        ...
        {
            DataGridViewNumericColumn newColumn = (DataGridViewNumericColumn)base.Clone();
    ...
    public partial class NumericGridCell : DataGridViewTextBoxCell
    {
        ...
        private NumberFormatInfo NumberFormat
        {
            get
            {
                return ((DataGridViewNumericColumn)OwningColumn).NumberFormat;
            }
        }
