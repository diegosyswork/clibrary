...
namespace SysWork.Data.Common.DbConnector
{
    ...
    public class DbConnectorOleDb : AbstractDbConnector
    {
        ...
        public override void Connect()
        {
            ...
            bool hasConnectionSuccess = DbUtil.ConnectionSuccess(EDataBaseEngine.OleDb, connectionSb.ConnectionString.ToString(), out string mensajeError);
            ...
            while (needConnectionParameters && PromptUser)
            {
                ...
                if (frmGetParamOleDb.DialogResult == DialogResult.OK)
                {
                    ...
                    hasConnectionSuccess = DbUtil.ConnectionSuccess(EDataBaseEngine.OleDb , connectionSb.ConnectionString.ToString(), out mensajeError);
                    ConnectionError = mensajeError;
                }
                else
                {
