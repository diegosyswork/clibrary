...
namespace SysWork.Data.GenericRepository.CodeWriter
{
    ...
    public class EntityClassFromDb
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityClassFromDb"/> class.
        /// </summary>
        ...
        public EntityClassFromDb(EDataBaseEngine dataBaseEngine, string ConnectionString, string DbTableName, string ClassName, string NameSpace)
        {
