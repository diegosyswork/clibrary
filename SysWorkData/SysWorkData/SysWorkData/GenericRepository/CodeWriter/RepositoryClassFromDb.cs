...
namespace SysWork.Data.GenericRepository.CodeWriter
{
    ...
    public class RepositoryClassFromDb
    {
        ...
        public RepositoryClassFromDb(string ConnectionString, string EntityName, string NameSpace, string DbTableName)
        {
        ...
        /// <param name="NameSpace">The name space.</param>
        /// <param name="DbTableName">Name of the database table.</param>
        public RepositoryClassFromDb(EDataBaseEngine databaseEngine, string ConnectionString, string EntityName, string NameSpace, string DbTableName)
        {
