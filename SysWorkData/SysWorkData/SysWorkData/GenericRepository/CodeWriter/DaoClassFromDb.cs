...
namespace SysWork.Data.GenericRepostory.CodeWriter
{
    public class DaoClassFromDb
    {
        ...
        private string GetTextClass()
        {
            ...
            builder.AppendLine(CodeWriterUtil.AddUsing("SysWork.Data.GenericRepostory"));
            ...
            builder.AppendLine(CodeWriterUtil.StartClass(_className, string.Format("BaseGenericRepository<{0}>", _entityName)));
