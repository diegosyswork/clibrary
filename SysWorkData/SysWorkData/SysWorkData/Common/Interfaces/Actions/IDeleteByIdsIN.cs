...
namespace SysWork.Data.Common.Interfaces.Actions
{
    ...
    public interface IDeleteByIdsIN<TEntity>
    {
        /// <summary>
        /// Deletes a record by the identifier.
        /// </summary>
        ...
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids);
        ...
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, int commandTimeOut);
        ...
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbConnection dbConnection);
        ...
        /// <param name="commandTimeOut">The command time out.</param>
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbConnection dbConnection, int commandTimeOut);
        ...
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbTransaction dbTransaction);
        ...
        /// <param name="commandTimeOut">The command time out.</param>
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbTransaction dbTransaction, int commandTimeOut);
        ...
        /// <param name="dbTransaction">The database transaction.</param>
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbConnection dbConnection, IDbTransaction dbTransaction);
        ...
        /// <param name="commandTimeOut">The command time out.</param>
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbConnection dbConnection, IDbTransaction dbTransaction, int commandTimeOut);
        ...
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbConnection dbConnection, IDbTransaction dbTransaction, out long recordsAffected);
        ...
        /// <param name="commandTimeOut">The command time out.</param>
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, IDbConnection dbConnection, IDbTransaction dbTransaction, out long recordsAffected, int? commandTimeOut);
        ...
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, out string errMessage);
        ...
        /// <param name="commandTimeOut">The command time out.</param>
        /// <returns></returns>
        bool DeleteByIdsIN(IEnumerable<object> ids, out string errMessage, int commandTimeOut);
    }
}
