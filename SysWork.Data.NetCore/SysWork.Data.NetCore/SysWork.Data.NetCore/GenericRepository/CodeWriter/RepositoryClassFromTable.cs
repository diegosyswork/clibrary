...
namespace SysWork.Data.NetCore.GenericRepository.CodeWriter
{
    /// <summary>
    ...
    public class RepositoryClassFromTable
    {
        ...
        private string GetTextClass()
        {
            ...
            builder.AppendLine(CodeWriterHelper.AddUsing("SysWork.Data.NetCore.Common"));
            builder.AppendLine(CodeWriterHelper.AddUsing("SysWork.Data.NetCore.GenericRepository"));
            builder.AppendLine(CodeWriterHelper.AddUsing("SysWork.Data.NetCore.Common.Attributes"));
            builder.AppendLine(CodeWriterHelper.AddUsing("SysWork.Data.NetCore.Common.ValueObjects"));
