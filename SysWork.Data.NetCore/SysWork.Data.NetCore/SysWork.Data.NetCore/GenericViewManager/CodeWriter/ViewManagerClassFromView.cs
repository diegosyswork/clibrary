...
namespace SysWork.Data.NetCore.GenericViewManager.CodeWriter
{
    ...
    public class ViewManagerClassFromView
    {
        ...
        private string GetTextClass()
        {
            ...
            builder.AppendLine(CodeWriterViewHelper.AddUsing("SysWork.Data.NetCore.Common"));
            builder.AppendLine(CodeWriterViewHelper.AddUsing("SysWork.Data.NetCore.GenericViewManager"));
            builder.AppendLine(CodeWriterViewHelper.AddUsing("SysWork.Data.NetCore.Common.Attributes"));
            builder.AppendLine(CodeWriterViewHelper.AddUsing("SysWork.Data.NetCore.Common.ValueObjects"));
