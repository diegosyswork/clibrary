...
using SysWork.Data.DaoModel.LambdaSqlBuilder.Resolver.ExpressionTree;
using SysWork.Data.DaoModel.LambdaSqlBuilder.ValueObjects;

namespace SysWork.Data.DaoModel.LambdaSqlBuilder.Resolver
{
            ...
            switch (memberExpression.Expression.NodeType)
            {
                case ExpressionType.Parameter:
                    return new MemberNode()
                               {TableName = LambdaResolver.GetTableName(rootExpression), FieldName = GetColumnName(rootExpression)};
