...
namespace SysWork.Controls.DockingControls
{
    public interface IDockingControl
    {
        ...
        bool AutoHideButtonVisible { get; set; }
        bool ToggleTabButtonVisible { get; set; }
    }
    ...
    internal partial class DockingControl : UserControl, IDockingControl
    {
        ...
        public bool CloseButtonVisible
        {
            get
            {
                return _toolStripButtonClose.Visible;
            }

            set
            {
                _toolStripButtonClose.Visible = value;
            }
        }
        public bool AutoHideButtonVisible
        {
            get
            {
                return _autoHidetoolStripButton.Visible;
            }

            set
            {
                _autoHidetoolStripButton.Visible = value;
            }
        }

        public bool ToggleTabButtonVisible
        {
            get
            {
                return _tabsToolStripButton.Visible;
            }

            set
            {
                _tabsToolStripButton.Visible = value;
            }
        }
        ...
        protected virtual void OnAutoHideChanged()
        {
            if (_autoHide)
            {
                _autoHidetoolStripButton.Image = global::SysWork.Controls.DockingControls.Properties.Resources.AutoHideOn;
                _tabsToolStripButton.Visible = false;
            }
            else
            {
                _autoHidetoolStripButton.Image = global::SysWork.Controls.DockingControls.Properties.Resources.AutoHideOff;
