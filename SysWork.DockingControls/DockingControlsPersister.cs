...
namespace SysWork.Controls.DockingControls.Serialization
{
    public static class DockingControlsPersister
    {
        ...
        static public string SerializeXMLString(DockingManagerControl manager)
        {
            DockingManagerControlData data = new DockingManagerControlData(manager);
            XmlSerializer serializer = new XmlSerializer(typeof(DockingManagerControlData));
            StringWriter stringtWriter = new StringWriter();

            serializer.Serialize(stringtWriter, data);

            return stringtWriter.ToString();
        }
        ...
        static public void DeserializeXMLString(DockingManagerControl manager,string xmlString)
        {
        ...
        static public void Deserialize(DockingManagerControl manager, StreamReader reader)
        {
            ...
            DockingManagerControlData dockingManagerControlData =(DockingManagerControlData)serializer.Deserialize(reader);
