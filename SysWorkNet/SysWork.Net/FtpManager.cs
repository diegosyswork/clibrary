...
namespace SysWork.Net
{
    class FtpManager
    {
        ...
        public void upload(string remoteFile, string localFile)
        {
            ...
            {
                Console.WriteLine(ex.ToString());
                throw new Exception("Error uploading", ex);
            }
            return;
        }
        ...
        public void rename(string currentFileNameAndPath, string newFileName)
        {
            ...
            {
                throw new Exception("Error renaming file ", ex);
            }
            return;
        }
        ...
        public void createDirectory(string newDirectory)
        {
            ...
            {
                throw new Exception("Error creating directory", ex);
            }
            return;
        }
        ...
        public string getFileCreatedDateTime(string fileName)
        {
            ...
            {
                throw new Exception("Error getFileCreatedDateTime file ", ex);
            }
        ...
        public string getFileSize(string fileName)
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ftpResponse.Close();
                    ftpRequest = null;
                    throw new Exception("Error getFileSize file ", ex);
                }
        ...
        public string[] directoryListSimple(string directory)
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ftpResponse.Close();
                    ftpRequest = null;
                    throw new Exception("Error directoryListSimple file ", ex);
                }
                /* Resource Cleanup */
                ftpReader.Close();
                ftpStream.Close();
                ...
                {
                    throw new Exception("Error directoryListSimple ", ex);
                }
            }
            catch (Exception ex)
            {
        ...
        public string[] directoryListDetailed(string directory)
        {
            try
            {
                ...
                /* EJEMPLO
                 * 
                *   host = @"ftp://nettuno-desktop.dyndns.org";
                */
                ftpRequest = (FtpWebRequest)FtpWebRequest.Create(host + "/" + directory);
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine(ex.ToString());
                throw new UriFormatException(host + " / " + directory, ex);
